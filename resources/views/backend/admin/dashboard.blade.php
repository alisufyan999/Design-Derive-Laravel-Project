        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <h2 class="mb-4">Welcome to Design Derive Admin</h2>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Contact Form Leads</h4>
                                                    ...
                                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                        ...
                                                        <tr>
                                                            @foreach ($columns as $column)
                                                                <th scope="col">{{ ucfirst($column) }}</th> <!-- Capitalize the first letter -->
                                                                @endforeach
                                                        ...
                                                        @foreach ($entries as $entry)
                                                            <tr>
                                                                @foreach ($columns as $column)
                                                                    <td>{{ $entry->$column }}</td> <!-- Access entry dynamically -->
                                                                @endforeach

                                                                <td>
                                                                    <form action="{{ route('backend.admin.delete', $entry->id) }}" method="POST" class="delete-form">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button class="btn btn-outline-danger dashboardbtn" type="submit" onclick="return confirm('Are you sure you want to delete this entry?');">Delete</button>
                                                                    </form>
                                                                </td>
                                                            </tr>
                                                        @endforeach
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Design Derive.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by KHAN
                            </div>
                        </div>
                    </div>
                </div>
