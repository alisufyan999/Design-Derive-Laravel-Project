        ...
        <div class="row justify-content-center height-100">
            <div class="col-md-6 col-sm-6 text-center my-auto">
                <div class="mainbannercontent mainbannercontentmob">
                    <h1 class="text-white">Get Beautiful And Branded Email Marketing Services</h1>
                    <p class="text-white">
                        Confirm your Logo accurately expresses your brand’s core values with our best corporate logo design service in the US. From our corporate logo design ideas, you can enhance your brand image.
                    </p>
                    <a href="#" class="moreportfoliobtn">Get Started Now</a>
                </div>
            </div>
               <div class="col-md-6 col-sm-6 text-center my-auto">
                   <img class="editorbar" src="{{ asset('frontend/assets/images/em-heroimg.png') }}" alt="" />
                </div>
        </div>
    </div>
    </div>
 ...
 <!-- Logo About start -->
        ...
        <div class="container">
            <div class="row mb-4 ipadactivitiesrow">
                 <div class="col-md-6 col-sm-12 my-auto">
                    <img class="editorbar" src="{{ asset('frontend/assets/images/em-img2.png') }}" />
                </div>
                <div class="col-md-6 col-sm-12 text-start my-auto">
                    <div class="sectionheadingdiv">
                        <h2 class="contactusheading">Look Professional With An Award-Winning Full-Service Best Branding Company</h2>
                        <div class="bar" style="margin: 13px 0px"></div>
                        <p>Companies usually underestimate the importance of corporate logos. Remember, all the brands, either SME or well-established, boomed; the Logo plays a great role. Having a corporate graphic design logo from professionals ike Logo Magicians makes your Logo stand out in the crowdie market.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-4 ipadactivitiesrow">
                <div class="col-md-6 col-sm-12 text-start my-auto">
                    <div class="sectionheadingdiv">
                        ...
                        <div class="bar" style="margin: 13px 0px"></div>
                         <p>
                            Companies usually underestimate the importance of corporate logos.
                            Remember, all the brands, either SME or well-established, boomed; the Logo
                            plays a great role. Having a corporate graphic design logo from professionals 
                            ike Logo Magicians makes your Logo stand out in the crowdie market.
                        </p>
                        <ul class="pointsul financiallist">
                          <li >Creative concepts</li>
                          <li >Custom Designs</li>
                          <li >Elegant visuals</li>
                          <li >100% ownership</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 my-auto">
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/email-marketing/2.webp') }}" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mb-5 section-padding-1920 pt-5 pb-0-1920">
        <div class="container">
            <div class="row mb-4 ipadactivitiesrow">
                 <div class="col-md-6 col-sm-12 my-auto">
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/email-marketing/3.webp') }}" />
                </div>
                <div class="col-md-6 col-sm-12 text-start my-auto">
                    <div class="sectionheadingdiv">
                        <h2 class="contactusheading">Look Professional With An Award-Winning Full-Service Best Branding Company</h2>
                        <div class="bar" style="margin: 13px 0px"></div>
                        <p>Companies usually underestimate the importance of corporate logos. Remember, all the 
                            brands, either SME or well-established, boomed; the Logo plays a great role. Having a 
                            corporate graphic design logo from professionals ike Logo Magicians makes your Logo stand 
                            out in the crowdie market.</p>
    ...
    <section class="section-padding-1920 pb-5 pt-5 pb-0-1920 " style="background-color: #f2f2f2">
        <div class="container">
            <div class="row mb-4 ipadactivitiesrow">
                ...
                <div class="col-md-6 col-sm-12 my-auto">
                    <img class="img-fluid" src="{{ asset('frontend/assets/images/email-marketing/4.webp') }}" />
                </div>
            </div>
        </div>
    </section>
